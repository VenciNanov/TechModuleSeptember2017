...
namespace _09.ObjectsAndClasses_Homework
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            DateTime startDate = DateTime.ParseExact(startInputDate, "d-M-yyyy", CultureInfo.InvariantCulture);
            DateTime endDate = DateTime.ParseExact(endInputDate, "d-M-yyyy", CultureInfo.InvariantCulture);
            ...
            for (DateTime i = startDate; i <= endDate; i = i.AddDays(1))
            {
                ...
                if (!holidays.Contains(temp) && (!day.Equals(DayOfWeek.Saturday)) && (!day.Equals(DayOfWeek.Sunday))&&!holidays.Contains(i))
                {
                    workingDaysCounter++;
                }
            }
